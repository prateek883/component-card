  ...
  return (
    <div className={styles.ContentContainer}>
      <Row sm={12}>
          ...
          <Card className={styles.subscribeCardBody}>
            <Card.Body>
              <h2 className={styles.newsletterTitle}>
                Check our Daily Newsletter
              </h2>
              <p className={styles.subscribeDescription}>
                Sign Up for updates related to tours, travels and amazing
                adventure that you wanna enjoy alot !
              </p>
        ...
        <Col xs={12} sm={5}>
          <Image
            src="https://images.pexels.com/photos/2217613/pexels-photo-2217613.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt="subscribe"
            className={styles.imageSusbcribe}
          ></Image>
        </Col>
      </Row>
    </div>
